...
const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted }) => {
  ...
  const [_actualTheme, setActualTheme] = useState<'light' | 'dark'>('light');
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-orange-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-500">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <FloatingShape delay={0} size="lg" position={{ top: '10%', left: '5%' }} />
        <FloatingShape delay={5} size="md" position={{ top: '60%', left: '90%' }} />
        <FloatingShape delay={10} size="sm" position={{ top: '80%', left: '40%' }} />
        <FloatingShape delay={3} size="lg" position={{ top: '40%', left: '95%' }} />
        <FloatingShape delay={8} size="md" position={{ top: '90%', left: '15%' }} />
       </div>
